...
class PveNode(BaseModel):
    ...
    status: Annotated[
        Literal["unknown", "online", "offline"], Field(description="Node status.")
    ]
    ...
    maxcpu: Annotated[
        int | None, Field(default=None, description="Number of available CPUs.")
    ]
    maxmem: Annotated[
        int | None,
        Field(default=None, description="Number of available memory in bytes."),
    ]
    mem: Annotated[int | None, Field(default=None, description="Used memory in bytes.")]
    ssl_fingerprint: Annotated[
        str | None,
        Field(
            default=None, description="The SSL fingerprint for the node certificate."
        ),
    ]
    uptime: Annotated[
        int | None, Field(default=None, description="Node uptime in seconds.")
    ]
...
class PveQemuVm(BaseModel):
    ...
    status: Annotated[
        Literal["stopped", "running"], Field(description="QEMU process status.")
    ]
    vmid: Annotated[
        int, Field(ge=100, le=999999999, description="The (unique) ID of the VM.")
    ]

    # optional fields
    cpu: Annotated[float | None, Field(default=None, description="Current CPU usage.")]
    cpus: Annotated[
        float | None, Field(default=None, description="Maximum usable CPUs.")
    ]
    diskread: Annotated[
        int | None,
        Field(
    ...
    lock: Annotated[
        str | None, Field(default=None, description="The current config lock, if any.")
    ]
    maxdisk: Annotated[
        int | None, Field(default=None, description="Root disk size in bytes.")
    ]
    maxmem: Annotated[
        int | None, Field(default=None, description="Maximum memory in bytes.")
    ]
    mem: Annotated[
        int | None, Field(default=None, description="Currently used memory in bytes.")
    ]
    ...
    serial: Annotated[
        bool | None,
        Field(default=None, description="Guest has serial device configured."),
    ]
    tags: Annotated[
        str | None,
        Field(default=None, description="The current configured tags, if any"),
    ]
    template: Annotated[
        bool, Field(default=False, description="Determines if the guest is a template.")
    ]
